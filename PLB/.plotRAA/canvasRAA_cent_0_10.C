...
//=========  (Tue Dec 18 18:24:31 2018) by ROOT version 6.12/07
   ...
   hNuclearModification__2->SetBinContent(1,0.3453176);
   hNuclearModification__2->SetBinContent(2,0.5039139);
   hNuclearModification__2->SetBinContent(3,0.469913);
   hNuclearModification__2->SetBinContent(4,0.6665264);
   hNuclearModification__2->SetBinContent(5,0.6822249);
   hNuclearModification__2->SetBinError(1,0.05165208);
   hNuclearModification__2->SetBinError(2,0.06051077);
   hNuclearModification__2->SetBinError(3,0.05437967);
   hNuclearModification__2->SetBinError(4,0.04949815);
   hNuclearModification__2->SetBinError(5,0.07886204);
   hNuclearModification__2->SetEntries(396.3965);
   ...
   hNuclearModification__3->SetBinContent(1,0.7613258);
   hNuclearModification__3->SetBinContent(2,0.6088896);
   hNuclearModification__3->SetBinContent(3,0.3374833);
   hNuclearModification__3->SetBinContent(4,0.1668411);
   hNuclearModification__3->SetBinContent(5,0.1796246);
   hNuclearModification__3->SetBinContent(6,0.175019);
   hNuclearModification__3->SetBinContent(7,0.2192556);
   hNuclearModification__3->SetBinContent(8,0.2246581);
   hNuclearModification__3->SetBinContent(9,0.2634928);
   hNuclearModification__3->SetBinError(1,0.1612207);
   hNuclearModification__3->SetBinError(2,0.09220124);
   hNuclearModification__3->SetBinError(3,0.03483479);
   hNuclearModification__3->SetBinError(4,0.02012718);
   hNuclearModification__3->SetBinError(5,0.0181541);
   hNuclearModification__3->SetBinError(6,0.01447137);
   hNuclearModification__3->SetBinError(7,0.01991343);
   hNuclearModification__3->SetBinError(8,0.02353607);
   hNuclearModification__3->SetBinError(9,0.03073991);
   hNuclearModification__3->SetEntries(223.7202);
