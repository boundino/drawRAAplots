...
std::map<std::string, exps::getdat*> dats = {
  std::pair<std::string, exps::getdat*>("STAR_D0_RAA_pt_0-10" , new exps::getdat("dataset/dat_charmRAA/STAR_D0_RAA_pt_0-10.dat" , xjjroot::mycolor_satmiddle["green"], "#bf{#it{STAR} AuAu} 200 GeV" , "0-10% D^{0}" , 21, 0.05, "log")),
  std::pair<std::string, exps::getdat*>("ALICE_D_RAA_pt_0-10" , new exps::getdat("dataset/dat_charmRAA/ALICE_D_RAA_pt_0-10.dat" , xjjroot::mycolor_satmiddle["red"], "#bf{#it{ALICE} PbPb} 5 TeV" , "0-10% Average D" , 20, 0.05, "log")),
  std::pair<std::string, exps::getdat*>("CMS_D0_RAA_pt_0-10" , new exps::getdat("dataset/dat_charmRAA/CMS_D0_RAA_pt_0-10.dat" , xjjroot::mycolor_satmiddle["yellow"], "#bf{#it{CMS} PbPb} 5 TeV" , "0-10% D0" , 20, 0.05, "log")),
};
...
void draw_charmRAA_pt(const std::vector<std::string>& idraw, std::string outname, float ymax)
{
  ...
  std::vector<std::string> legorder = {"ALICE_D_RAA_pt_0-10", "CMS_D0_RAA_pt_0-10", "STAR_D0_RAA_pt_0-10"};
...
int main()
{
  draw_charmRAA_pt(std::vector<std::string>({"CMS_D0_RAA_pt_0-10", "STAR_D0_RAA_pt_0-10", "ALICE_D_RAA_pt_0-10"}), "0", 1.25);
  return 0;
}
